...
function FutureActivitiesList() {
  ...
  useEffect(() => {
    axios.get(`${BACK_URL}/volunteer/future-activities`,
        {
          headers:
          {
  ...
  return (
    <section className="p-8">
      <h1 className="text-3xl font-bold text-gray-800 mb-8">Buduće aktivnosti</h1>
...
export default FutureActivitiesList;
