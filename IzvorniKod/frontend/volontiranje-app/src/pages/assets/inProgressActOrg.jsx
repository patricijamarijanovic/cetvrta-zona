...
function PrevActOrg({organizationId}) {
  ...
  useEffect(() => {
    axios.get(`${BACK_URL}/home/organization/in-progress-activities/${organizationId}`,
      {        
        headers:
        {            
  ...
  return (
    <section className="flex flex-col mb-4">
      <h4 className="text-gray-600 font-medium mb-2">Trenutne aktivnosti organizacije</h4>
      <div>
        {activities.length === 0 ? (
          <p className="text-gray-800">Organizacija trenutno ne održava niti jednu aktivnost.</p>
        ) : (
