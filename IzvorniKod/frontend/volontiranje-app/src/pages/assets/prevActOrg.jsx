...
function PrevActOrg({organizationId}) {
  ...
  useEffect(() => {
    axios.get(`${BACK_URL}/home/organization/previous-activities/${organizationId}`,
      {        
        headers:
        {            
  ...
  return (
    <section className="flex flex-col mb-4">
      <h4 className="text-gray-600 font-medium mb-2">Prethodne aktivnosti organizacije</h4>
      <div>
        {activities.length === 0 ? (
          <p className="text-gray-800">Organizacija još nije održala niti jednu aktivnost.</p>
        ) : (
